...
4. **Top Scene Selection (The Cut):** The system ranks all scenes by score and selects the absolute best scenes until the **Target Duration** (e.g., 3 minutes) is met. Less interesting scenes are discarded.
